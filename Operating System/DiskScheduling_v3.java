    ...
    public static int[] input() {
        ...
        try {
            ...
            while(true) {
                ...
                if(temp[0] <= 0) {
                    System.out.print("========================================\n");
                    System.out.println("Invalid Input: Current Position must be <= 0");
                    System.out.print("========================================\n");
                } else {
                    break;
                }
            ...
            while(true) {
                ...
                if(temp[1] <= 0 || temp[1] > 200) {
                    System.out.print("========================================\n");
                    System.out.println("Invalid Input: Track Size <= 0 and > 200");
                    System.out.print("========================================\n");
                } else {
                    break;
                }
            ...
            while(true) {
                ...
                if(temp[2] <= 0 || temp[2] > 10) {
                    System.out.print("========================================\n");
                    System.out.println("Invalid Input: Number of Request <= 0 AND > 10");
                    System.out.print("========================================\n");
                } else {
                    break;
                }
        ...
        {  
            try {
                ...
                if(placeholder < 0) {
                    ...
                    System.out.print("========================================\n");
                    i--;
                } else if(placeholder > trackSize) {
                    System.out.print("========================================\n");
                    System.out.println("Invalid Input: Value is greater than " + trackSize); 
                    System.out.print("========================================\n");
                    i--;
                } else {
                    temp[i] = placeholder; 
